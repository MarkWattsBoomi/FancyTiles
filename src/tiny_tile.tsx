...
import './tiny_tile.css';
import CommonFunctions from './CommonFunctions';

declare const manywho: any;

export default class TinyTile extends React.Component<any,any> {
    ...
    render() {
        ...
        let tileClass: string = 'mw-tiles-item-container tt-container';
        if(parent.selectedTile === tile.internalId) {
            tileClass += " tt-selected";
        }
